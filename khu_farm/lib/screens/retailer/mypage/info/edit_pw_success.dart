...
class RetailerEditPasswordSuccessScreen extends StatelessWidget {
  const RetailerEditPasswordSuccessScreen({super.key});

  void _navigateToMain(BuildContext context) {
    Navigator.popUntil(context, ModalRoute.withName('/retailer/main'));
  }
