...
class RetailerAccountCancellationScreen extends StatefulWidget {
  const RetailerAccountCancellationScreen({super.key});

  @override
  State<RetailerAccountCancellationScreen> createState() =>
      _RetailerAccountCancellationScreenState();
}

class _RetailerAccountCancellationScreenState
    extends State<RetailerAccountCancellationScreen> {
