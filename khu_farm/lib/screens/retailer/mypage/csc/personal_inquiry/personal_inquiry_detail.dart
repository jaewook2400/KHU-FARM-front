...
class RetailerPersonalInquiryDetailScreen extends StatefulWidget {
  final int inquiryId;

  const RetailerPersonalInquiryDetailScreen({
    super.key,
    required this.inquiryId,
  });

  @override
  State<RetailerPersonalInquiryDetailScreen> createState() =>
      _RetailerPersonalInquiryDetailScreenState();
}

class _RetailerPersonalInquiryDetailScreenState
    extends State<RetailerPersonalInquiryDetailScreen> {
