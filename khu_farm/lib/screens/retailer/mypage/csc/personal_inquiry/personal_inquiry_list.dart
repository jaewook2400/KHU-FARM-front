...
import 'package:khu_farm/screens/retailer/mypage/csc/personal_inquiry/personal_inquiry_detail.dart';
...
class RetailerPersonalInquiryListScreen extends StatefulWidget {
  const RetailerPersonalInquiryListScreen({super.key});

  @override
  State<RetailerPersonalInquiryListScreen> createState() =>
      _RetailerPersonalInquiryListScreenState();
}

class _RetailerPersonalInquiryListScreenState
    extends State<RetailerPersonalInquiryListScreen> {
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      ...
                      builder: (_) => RetailerPersonalInquiryDetailScreen(
