...
class RetailerDailyScreen extends StatefulWidget {
  const RetailerDailyScreen({super.key});

  @override
  State<RetailerDailyScreen> createState () => _RetailerDailyScreenState();
}
