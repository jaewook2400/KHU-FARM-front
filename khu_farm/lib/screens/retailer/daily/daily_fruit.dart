...
class RetailerDailyFruitScreen extends StatefulWidget {
  const RetailerDailyFruitScreen({super.key});

  @override
  State<RetailerDailyFruitScreen> createState() => _RetailerDailyFruitScreenState();
}

class _RetailerDailyFruitScreenState extends State<RetailerDailyFruitScreen> {
