...
import 'dart:convert';
import 'package:khu_farm/screens/retailer/notification_detail.dart';
...
class RetailerNotificationListScreen extends StatefulWidget {
  const RetailerNotificationListScreen({super.key});

  @override
  State<RetailerNotificationListScreen> createState() =>
      _RetailerNotificationListScreenState();
}

class _RetailerNotificationListScreenState
    extends State<RetailerNotificationListScreen> {
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (_) => RetailerNotificationDetailScreen(
                            title: title,
                            content: content,
                          ),
                    ),
