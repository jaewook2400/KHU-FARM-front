...
class ConsumerDibsScreen extends StatefulWidget {
  const ConsumerDibsScreen({super.key});

  @override
  State<ConsumerDibsScreen> createState() => _ConsumerDibsScreenState();
}

class _ConsumerDibsScreenState extends State<ConsumerDibsScreen> {
