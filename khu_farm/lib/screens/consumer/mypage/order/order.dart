...
class ConsumerOrderListScreen extends StatefulWidget {
  const ConsumerOrderListScreen({super.key});

  @override
  State<ConsumerOrderListScreen> createState() => _ConsumerOrderListScreenState();
}

class _ConsumerOrderListScreenState extends State<ConsumerOrderListScreen> {
  List<Order> _orders = [];
...
class _OrderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isReviewable = (order.deliveryStatus?.currentStateText == 'SHIPMENT_COMPLETED') | (order.deliveryStatus?.currentStateText == '배송 완료') ;
