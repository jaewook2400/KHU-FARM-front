...
class ConsumerEditPasswordSuccessScreen extends StatelessWidget {
  const ConsumerEditPasswordSuccessScreen({super.key});

  void _navigateToMain(BuildContext context) {
    Navigator.popUntil(context, ModalRoute.withName('/consumer/main'));
  }
