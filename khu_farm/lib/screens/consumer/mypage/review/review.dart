...
class ConsumerReviewListScreen extends StatefulWidget {
  const ConsumerReviewListScreen({super.key});

  @override
  State<ConsumerReviewListScreen> createState() =>
      _ConsumerReviewListScreenState();
}

class _ConsumerReviewListScreenState extends State<ConsumerReviewListScreen> {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onTap: () => Navigator.pushNamedAndRemoveUntil(context, '/consumer/main', (route) => false),
                  child: const Text('KHU:FARM', textAlign: TextAlign.center, style: TextStyle(fontFamily: 'LogoFont', fontSize: 22, color: Colors.white)),
                ),
                Row(
                  children: [
                    GestureDetector(onTap: () => Navigator.pushNamed(context, '/consumer/notification/list'), child: Image.asset('assets/top_icons/notice.png', width: 24, height: 24)),
                    const SizedBox(width: 12),
                    GestureDetector(onTap: () => Navigator.pushNamed(context, '/consumer/dib/list'), child: Image.asset('assets/top_icons/dibs.png', width: 24, height: 24)),
                    const SizedBox(width: 12),
                    GestureDetector(onTap: () => Navigator.pushNamed(context, '/consumer/cart/list'), child: Image.asset('assets/top_icons/cart.png', width: 24, height: 24)),
                  ],
                ),
              ],
            ),
