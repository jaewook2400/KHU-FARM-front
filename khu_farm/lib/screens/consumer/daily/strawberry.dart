...
class ConsumerStrawberryScreen extends StatelessWidget {
  const ConsumerStrawberryScreen({super.key});
...
class _StrawberryProductItem extends StatelessWidget {
