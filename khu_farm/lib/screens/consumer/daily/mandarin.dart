...
class ConsumerMandarinScreen extends StatelessWidget {
  const ConsumerMandarinScreen({super.key});
...
class _MandarinProductItem extends StatelessWidget {
