...
import 'dart:convert';
import 'package:khu_farm/screens/farmer/notification_detail.dart';
...
class FarmerNotificationListScreen extends StatefulWidget {
  const FarmerNotificationListScreen({super.key});

  @override
  State<FarmerNotificationListScreen> createState() =>
      _FarmerNotificationListScreenState();
}

class _FarmerNotificationListScreenState
    extends State<FarmerNotificationListScreen> {
