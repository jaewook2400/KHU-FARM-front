...
class _FarmerDailyFruitScreenState extends State<FarmerDailyFruitScreen> {
  ...
  Future<void> _searchFruits(String keyword) async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/fruits/search/{wholesaleRetailCategoryId}/{fruitCategoryId}?wholesaleRetailCategoryId=2&fruitCategoryId=$_fruitCategoryId&searchKeyword=$keyword'),
        headers: headers,
      );
