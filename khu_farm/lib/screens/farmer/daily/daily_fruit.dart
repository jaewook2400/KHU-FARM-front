...
class FarmerDailyFruitScreen extends StatefulWidget {
  const FarmerDailyFruitScreen({super.key});

  @override
  State<FarmerDailyFruitScreen> createState() => _FarmerDailyFruitScreenState();
}

class _FarmerDailyFruitScreenState extends State<FarmerDailyFruitScreen> {
