...
class FarmerAddAddressScreen extends StatefulWidget {
  const FarmerAddAddressScreen({super.key});

  @override
  State<FarmerAddAddressScreen> createState() =>
      _FarmerAddAddressScreenStatus();
}

class _FarmerAddAddressScreenStatus extends State<FarmerAddAddressScreen> {
