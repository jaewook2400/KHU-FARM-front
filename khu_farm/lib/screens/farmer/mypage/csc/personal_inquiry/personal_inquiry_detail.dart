...
class FarmerPersonalInquiryDetailScreen extends StatefulWidget {
  final int inquiryId;

  const FarmerPersonalInquiryDetailScreen({
    super.key,
    required this.inquiryId,
  });

  @override
  State<FarmerPersonalInquiryDetailScreen> createState() =>
      _FarmerPersonalInquiryDetailScreenState();
}

class _FarmerPersonalInquiryDetailScreenState
    extends State<FarmerPersonalInquiryDetailScreen> {
