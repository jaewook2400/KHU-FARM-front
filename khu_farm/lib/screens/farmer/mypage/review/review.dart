...
class FarmerReviewListScreen extends StatefulWidget {
  const FarmerReviewListScreen({super.key});

  @override
  State<FarmerReviewListScreen> createState() =>
      _FarmerReviewListScreenState();
}

class _FarmerReviewListScreenState extends State<FarmerReviewListScreen> {
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    // GestureDetector(onTap: () => Navigator.pushNamed(context, '/farmer/notification/list'), child: Image.asset('assets/top_icons/notice.png', width: 24, height: 24)),
                    const SizedBox(width: 12),
                    GestureDetector(onTap: () => Navigator.pushNamed(context, '/farmer/dib/list'), child: Image.asset('assets/top_icons/dibs.png', width: 24, height: 24)),
                    const SizedBox(width: 12),
                    GestureDetector(onTap: () => Navigator.pushNamed(context, '/farmer/cart/list'), child: Image.asset('assets/top_icons/cart.png', width: 24, height: 24)),
                  ],
                ),
              ],
            ),
